//CREATE TESTIMONIALS
function partnerStoreRecord() {
    var form = $('#esta-create-partners-record-form');
    $(".form-group .form-control").removeClass("has-error");
    $(".error").html("");
    var formNode = document.getElementById('esta-create-partners-record-form');
    $.ajax({
        ...
        success: function(result) {
            ...
            switch (type) {
                ...
                case 'success':
                    ...
                    setTimeout(function() {
                        window.location.href = "/administration/partners";
