//CREATE TESTIMONIALS
function testimonialStoreRecord() {
    var form = $('#esta-create-testimonials-record-form');
    $(".form-group .form-control").removeClass("has-error");
    $(".error").html("");
    var formNode = document.getElementById('esta-create-testimonials-record-form');
    $.ajax({
        ...
        success: function(result) {
            ...
            switch (type) {
                ...
                case 'success':
                    ...
                    setTimeout(function() {
                        window.location.href = "/administration/testimonials";
