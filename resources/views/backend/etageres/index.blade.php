...
@section('title', "CLADOS - Gestion des étagères")
@section('content')
            ...
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-toolbar">
                        <div class="row">
                            <div class="col">
                                <h5 class="text-dark font-weight-bold my-1 mr-5">Liste des Etageres</h5>
                            </div>
                            @permission('etagere-créer')
                            <div class="col">
                                <button onclick="createRecord('{{route('etagere.create')}}')" class="btn btn-dark btn-flat">
