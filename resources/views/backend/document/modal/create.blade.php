    ...
    <div class="modal-dialog modal-dialog-centered" style="width: 1000px" role="document">
        <div class="modal-content border-0 shadow radius-1">
            ...
            <div class="modal-body modal-scroll">
                <form action="{{route('document.store')}}" method="POST" id="app-record-form-datatable">
                    @csrf
                    <div class="form-group ">
                        <label for=""><strong>TITRE DOCUMENT</strong></label>
                        <input type="text" name="titre" class="form-control " id="id-form-field-1">
