...
@section('title', "CLADOS - Gestion des classeurs")
@section('content')
            ...
            <div class="card custom-card">
                <div class="card-header">
                    <div class="card-toolbar">
                        <div class="row">
                            <div class="col">
                                <h5 class="text-dark font-weight-bold my-1 mr-5">Liste des Classeurs</h5>
                            </div>
                            @permission('classeur-créer')
                            <div class="col">
                                <button onclick="createRecord('{{route('classeur.create')}}')" class="btn btn-dark btn-flat">
...
@section('js')
    ...
    <script>
        $('#app-datatable').DataTable({
            ...
            ajax: '{!! route('classeur.datatables') !!}',
            columns: [
